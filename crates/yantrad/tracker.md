...
background (Y-069, Y-070). All but the last two of the invariants below were earned during research,
before there was anywhere to put them, and **none has been exercised by shipped code yet** — the
daemon holds no state on disk and makes no placement decisions. **I-58 and I-59 are the exception in
one half**: both were read off shipped code rather than off research, and neither has ever been seen.
