...
const trust: Event = { at: 100, kind: 'awaiting_trust', workspace: 'api', machine: 'pi', said: 'wants cargo test', commands: [], joined: null }
const relay: Event = { at: 50, kind: 'relay-test', workspace: null, machine: null, said: 'reached', commands: [], joined: null }
const gone: Event = { at: 75, kind: 'unreachable', workspace: null, machine: 'thinkpad', said: 'no route', commands: [], joined: null }
