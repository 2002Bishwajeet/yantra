...
| **Updated by** | Claude (session: M1 walking skeleton) |
...
| Y-020 | Synthesise research → architecture decisions | 🔵 doing | claude | Y-010..Y-015 | ADR-0004 (runtime) ✅, ADR-0005 (core library crate) ✅, ADR-0007 (workspace schema) ✅. Remaining: ADR-0006 (transport), ADR-0008 (telemetry). ADR-0009 blocked on Y-023. |
...
| 0008 | Claude Code integration (**not** a plugin interface — see the one-agent-first guardrail) | — | unblocked; Y-023 refuted R-1 |
